...
nnoremap <silent> ;ae 02xi\AErussell:<CR><Esc>
nnoremap <silent> ;ba 02xi\bantam:<CR><Esc>
nnoremap <silent> ;bt 02xi\best:<CR><Esc>
nnoremap <silent> ;cr 02xi\curate:<CR><Esc>
nnoremap <silent> ;db 02xi\davybyrne:<CR><Esc>
nnoremap <silent> ;eg 02xi\eglinton:<CR><Esc>
nnoremap <silent> ;jj 02xi\jjom:<CR><Esc>
nnoremap <silent> ;lh 02xi\lenehan:<CR><Esc>
nnoremap <silent> ;ly 02xi\librarian:<CR><Esc>
nnoremap <silent> ;mu 02xi\mulligan:<CR><Esc>
