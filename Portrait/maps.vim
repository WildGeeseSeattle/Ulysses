...
nnoremap <silent> ;sd 0xi\Stephen:<CR><Esc>
nnoremap <silent> ;si 0i<CR>\StephenInt:<CR><Esc>
nnoremap <silent> ;ss 0xi\simon:<CR><Esc>
nnoremap <silent> ;cd 0xi\charles:<CR><Esc>
nnoremap <silent> ;md 0xi\marydedalus:<CR><Esc>
nnoremap <silent> ;dr 0xi\dante:<CR><Esc>
nnoremap <silent> ;jc 0xi\casey:<CR><Esc>
