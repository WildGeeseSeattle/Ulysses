...
nnoremap <silent> ;ct 02x0i\Cat:<CR><Esc>
nnoremap <silent> ;mb 02x0i\Molly:<CR><Esc>
nnoremap <silent> ;or 02x0i\ORourke:<CR><Esc>
nnoremap <silent> ;dl 02x0i\Dlugacz:<CR><Esc>
