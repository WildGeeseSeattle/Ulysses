    ...
    <xsl:template match="/">
        ...
        <html>
            ...
            <head><xsl:text>&#10;</xsl:text>
                ...
                <xsl:text>&#10;</xsl:text>
                <link rel="stylesheet" type="text/css" media="all" href="./ulysses.css" />
                <xsl:text>&#10;</xsl:text>
            </head>
            <xsl:text>&#10;</xsl:text>
            <body>
...
-->
    ...
    <xsl:template name="narrator">
        ...
        <xsl:text>&#10;&#10;</xsl:text>
        <div>
            <xsl:attribute name="class">narrator<xsl:value-of select="$number"/></xsl:attribute>
            <span>
                <xsl:attribute name="class">narrator<xsl:value-of select="$number"/></xsl:attribute>N<xsl:value-of select="$number"/>: </span>
            <xsl:text>&#10;</xsl:text>
            <xsl:apply-templates />
        </div>
    </xsl:template>
    ...
    <xsl:template match="slut">
        <xsl:call-template name="speaker">
            <xsl:with-param name="name">Slut</xsl:with-param>
        </xsl:call-template>
    </xsl:template>
    ...
    <xsl:template match="oreilly">
        <xsl:call-template name="speaker">
            <xsl:with-param name="name">O'Reilly</xsl:with-param>
        </xsl:call-template>
    </xsl:template>
