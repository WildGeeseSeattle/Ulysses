...
\histstyle{Sallust, Tacitus}{0:00:42}
...
\french{parceque M.~Leo Taxil nous a dit que |
qui l'avait mise |
...
\histstyle{Milton, Hooker}{0:29:22}
...
and the anthem |
\latin{Ut novetur sexus omnis corporis mysterium} |
till she was there |
unmaided.
...
In the proud cirque of Jack·john's bivouac.}

\histstyle{Burton, Browne}{0:36:01}
...
\histstyle{Evelyn, Pepys}{0:42:12}
...
\histstyle{Addison, Steele}{0:57:11}
...
\histstyle{Burke, Johnson}{1:13:05}
...
the acardiac \latin{foetus in foetu} and aprosopia |
due to a congestion,
...
called by the Brandenburghers \german{Sturzgeburt},
...
were alleged by one as a \latin{prima facie} |
...
between the \latin{nisus formativus} of the nemasperm |
on the one hand |
and on the other |
...
towards where his mother watches from the \italian{piazzetta} |
giving upon the flower·close |
with a faint shadow of remoteness |
or of reproach
(\german{alles Vergängliche})
in her glad look.
\end{omitted}

\histstyle{Ruskin}{2:00:20}
...
giving the cry,
\stage{all except narrators stand}
...
\german{Deine Kuh Trübsal melkest Du.
...
\histstyle{Coda {\#}1}{2:06:19}

\stage{Much of the rest is randomly assigned. Your guess is as good as mine.}
