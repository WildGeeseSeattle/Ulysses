...
\N{1,2}: Deshil Holles Eamus.

\N{1,2,3}: Deshil Holles Eamus.

\N1: Send us bright one, light one, Horhorn, quickening and wombfruit.

\N{1,2}: Send us bright one, light one, Horhorn, quickening and wombfruit.

\N{1,2,3}: Send us bright one, light one, Horhorn, quickening and wombfruit.
...
\N1: It is not why therefore we shall wonder if, as the best historians
...
\nursecallan: I begged ye at the reverence of Jesu our alther liege Lord
...
\Bloom: I marvel that it be not come or now. Meseems it dureth overlong.

\N3: And he was ware and saw a franklin that hight Lenehan on that side
the table that was older than any of the tother and for that they both
were knights virtuous in the one emprise and eke by cause that he was
elder he spoke to him full gently.

\Bloom: But or it be long too she will bring forth by God His bounty and
have joy of her childing for she hath waited marvellous long.

\N1: And the franklin that had drunken said:

\lenehan: Expecting each moment to be her next.
...
\N1: Dixon yclept junior of saint Mary Merciable's. \stage{Dixon bows}

\N2: With other his fellows, Lynch. \stage{Lynch bows}

\N3: And Madden, scholars of medicine. \stage{Madden bows}

\N1: And the franklin that hight Lenehan. \stage{Lenehan bows}

\N2: And one from Alba Longa, one Crotthers. \stage{Crotthers bows}

\N3: And young Stephen \stage{Stephen bows}
that had mien of a frere that was at head of the board.

\N1: And Costello that men clepen Punch Costello. \stage{Costello bows}
...
\N3: For they were right witty scholars. And he heard their aresouns each
...
\N1: And they said farther she should live because in the beginning, they
...
\N1: Then spake young Stephen orgulous of mother Church that would cast
...
man has but lain with, \latin{effectu secuto}, or peradventure in her bath
...
\N3: A wariness of mind he would answer as fitted all and, laying hand to
...
\N1: Which hearing young Stephen was a marvellous glad man and he averred
...
\N2: But sir Leopold was passing grave maugre his word by cause he still
...
\N3: About that present time young Stephen filled all cups that stood
...
\N1: And he showed them glistering coins of the tribute and goldsmith
...
venerable and Bernardus saith aptly that She hath an \latin{omnipotentiam
...
and was but creature of her creature, \italian{vergine madre, figlia di tuo
...
marriages, \french{parceque M. Leo Taxil nous a dit que qui l'avait mise
dans cette fichue position c'etait le sacre pigeon, ventre de Dieu!}
\german{Entweder} transubstantiality \german{oder} consubstantiality
...
sing a bawdy catch \song{Staboo Stabella} about a wench that was
put in pod of a jolly swashbuckler in Almany which he did straightways
now attack:

\punch: \song{The first three months she was not well, staboo.}
...
\N3: Master Lenehan at this made return that he had heard of
...
the anthem \latin{Ut novetur sexus omnis corporis mysterium}
...
secondbest bed. \latin{Orate, fratres, pro memetipso}. And all the people
...
prenativity and postmortemity is their most proper \latin{ubi} and \latin{quomodo}.
...
\N1: Thereto Punch Costello roared out mainly \french{Étienne chanson}
but he loudly bid them.

\stephen: Lo, wisdom hath built herself a house, this vast majestic
longstablished vault, the crystal palace of the Creator, all in applepie
order, a penny for him who finds the pea.

\stephen: \song{Behold the mansion reared by dedal Jack{}\\
...
\N2: A black crack of noise in the street here, alack, bawled back.
Loud on left Thor thundered: in anger awful the hammerhurler.
Came now the storm that hist his heart.

\lynch: Have a care to flout and witwanton as the god self is angered for
your hellprate and paganry.

\N3: And he that had erst challenged to be so doughty waxed wan as they
...
\stephen: An old Nobodaddy is in his cups it was muchwhat indifferent and
...
\Bloom: It was no other thing but a hubbub noise that you heard, the
...
\N2: But was young Boasthard's fear vanquished by Calmer's words?
...
\N3: Indeed no for Grace was not there to find that bottle. Heard he then
...
\N2: Yes, Pious had told him of that land and Chaste had pointed him to
...
\N1: For, First, Two-in-the-Bush whither she ticed them was the very
...
\N2: And, second, for that foul plague Allpox and the monsters they cared
...
\N1: So Thursday sixteenth June Patrick Dignam laid in clay of an apoplexy
...
\N2: But by and by, as said, this evening after sundown, the wind sitting
...
\N3: In Ely place, Baggot street, Duke's lawn, thence through Merrion
...
\N1: There Leopold Bloom of Crawford's journal sitting snug with a covey
...
\N2: 'Tis her ninth chick to live, I hear, and Lady day bit off her last
...
\N2: He was a kind of sport gentleman that went for a merryandrew or
...
\N3: runners, flatcaps, waistcoateers, ladies of the bagnio and other
...
\N1: He took his ordinary at a boilingcook's and if he had but gotten into
...
\punch: Is it poetry or a tale?

\lenehan: Faith, no, Frank, 'tis all about Kerry cows that are to be butchered
...
\N3: And very friendly he offered to take of some salty sprats that stood
...
\punch: \french{Mort aux vaches.}

\N1: Says Frank then in the French language that had been indentured to a
...
\Bloom: What, will they slaughter all? I protest I saw them but this day
...
\Bloom: I question with you there.
...
\lynch: Come, come, plain dealing.
He'll find himself on the horns of a dilemma if he meddles
with a bull that's Irish.

\stephen: Irish by name and Irish by nature.
An Irish bull in an English chinashop.

\dixon: I conceive you. It is that same bull that was sent to our island by
farmer Nicholas, the bravest cattlebreeder of them all, with an emerald
ring in his nose.

\lynch: True for you, and a bullseye into the bargain, and a
...
\dixon: What for that, but before he came over farmer Nicholas
...
\lynch: But the slap and the blessing stood him friend, for to make up he
...
\madden: And they dressed him, in a point shift and petticoat with a tippet
...
\lenehan: Ay, and so pampered was he that he would suffer nought to grow in all
...
\dixon: And, if ever he got scent of a cattleraider in Roscommon or the wilds
...
\lynch: There was bad blood between them at first,
...
\dixon: But one evening, when the lord Harry was cleaning his royal pelt to
...
bull of the Romans, \latin{Bos Bovum}, which is good bog Latin for boss of
the show.

\lynch: After that, the lord Harry put his head into a cow's drinkingtrough
...
\stephen: They were, and the end was that the men of the island seeing no help
...
\lynch: Which was the occasion, of the composing by a boatswain of that
rollicking chanty:

\lynch: \song{Pope Peter's but a pissabed.\\
...
\N2: Our worthy acquaintance Mr Malachi Mulligan \stage{bows} now appeared
...
Alec Bannon \stage{bows}, who had late come to town, it being his
intention to buy a colour or a cornetcy in the fencibles and list for the
wars.

\N3: Mr Mulligan was civil enough to express some relish of it all the
...
\dixon: Well, let us hear of it, good my friend. I make no doubt it
smacks of wenching. Come, be seated, both. 'Tis as cheap sitting as
standing.

\N1: Mr Mulligan accepted of the invitation and, expatiating upon his
design, told his hearers that he had been led into this thought by a
consideration of the causes of sterility.

\mulligan: Both the inhibitory and the prohibitory, whether the inhibition in
...
fertilising farm to be named \latin{Omphalos} with an obelisk hewn and
...
\N2: For his nutriment he showed how he would feed himself exclusively
...
\N3: After this homily which he delivered with much warmth of asseveration
...
\N1: Mr Mulligan however made court to the scholarly by an apt quotation
from the classics which, as it dwelt upon his memory, seemed to him a
sound and tasteful support of his contention:

\mulligan: \latin{Talis ac tanta depravatio hujus seculi, O quirites, ut
...
\N2: While for those of ruder wit he drove home his point by analogies of
the animal kingdom more suitable to their stomach, the buck and doe of the
forest glade, the farmyard drake and duck.

% Week #26

\N3: Valuing himself not a little upon his elegance, being indeed a proper
...
\mulligan: \stage{to Bloom} Pray, sir, was you in need of any professional
...
\Bloom: I am come here about a lady, now an inmate of Horne's house, that is
in an interesting condition, poor body, from woman's woe \stage{sighs} to
know if her happiness has yet taken place.

\N3: Mr Dixon, to turn the table, took on to ask of Mr Mulligan himself:

\dixon: Whether your incipient ventripotence betokens an ovoblastic gestation
in the prostatic utricle or male womb, or is due, as with the noted
physician, Mr Austin Meldon, to a wolf in the stomach?

\N1: For answer Mr Mulligan, in a gale of laughter at his smalls, smote
...
pity she's a trollop):

\mulligan: There's a belly that never bore a bastard.

\N2: This was so happy a conceit that it renewed the storm of mirth and
...
\bannon: \french{Mais bien sûr}, noble stranger, \french{et mille compliments}.
...
\N1: With these words he approached the goblet to his lips, took a complacent
...
\bannon: Ah, Monsieur, had you but beheld her as I did with these eyes at that
affecting instant with her dainty tucker and her new coquette cap (a gift
for her feastday as she told me prettily) in such an artless disorder, of
so melting a tenderness, 'pon my conscience, even you, Monsieur, had been
...
\N2: A sigh of affection gave eloquence to these words and, having
replaced the locket in his bosom, he wiped his eye and sighed again.

\bannon: Beneficent Disseminator of blessings to all Thy creatures, how great
...
years. But indeed, sir, I wander from the point. How mingled and imperfect
are all our sublunary joys. Maledicity! \stage{exclaimed in anguish} Would
to God that foresight had but remembered me to take my cloak along! I
could weep to think of it. Then, though it had poured seven showers, we
were neither of us a penny the worse. But beshrew me, \stage{clapping hand
to his forehead} tomorrow will be a new day and, thousand thunders, I know
of a \french{marchand de capotes}, Monsieur Poyntz, from whom I can have
for a \french{livre} as snug a cloak of the French fashion as ever kept a
lady from wetting.

\N3: Tut, tut! cries Le Fecondateur, tripping in.

\mulligan: My friend Monsieur Moore, that most accomplished traveller (I have
just cracked a half bottle \french{avec lui} in a circle of the best wits
of the town), is my authority that in Cape Horn, \french{ventre biche},
they have a rain that will wet through any, even the stoutest cloak. A
drenching of that violence, he tells me, \french{sans blague}, has sent
more than one luckless fellow in good earnest posthaste to another world.

\lynch: Pooh! A \french{livre}! The clumsy things are dear at a sou. One
umbrella, were it no bigger than a fairy mushroom, is worth ten such
stopgaps. No woman of any wit would wear one. My dear Kitty told me today
that she would dance in a deluge before ever she would starve in such an
ark of salvation for, as she reminded me (blushing piquantly and
whispering in my ear though there was none to snap her words but giddy
butterflies), dame Nature, by the divine blessing, has implanted it in our
hearts and it has become a household word that \french{il y a deux choses}
...
chamber of my ear), the first is a bath\dots.
...
\N2: Amid the general vacant hilarity of the assembly a bell rang and,
...
with a profound bow to the company.

\N3: The presence even for a moment among a party of debauchees of a woman
endued with every quality of modesty and not less severe than beautiful
refrained the humourous sallies even of the most licentious but her
departure was the signal for an outbreak of ribaldry.

\N1: Strike me silly, said Costello, a low fellow who was fuddled.

\punch: A monstrous fine bit of cowflesh! I'll be sworn she has rendezvoused
you. What, you dog? Have you a way with them?

\lynch: Gad's bud, immensely so. The bedside manner it is that they use in
the Mater hospice. Demme, does not Doctor O'Gargle chuck the nuns there
under the chin. As I look to be saved I had it from my Kitty who has been
wardmaid there any time these seven months. Lawksamercy, doctor,
\stage{feigning a womanish simper and with immodest squirmings of his
body} how you do tease a body! Drat the man! Bless me, I'm all of a wibbly
wobbly. Why, you're as bad as dear little Father Cantekissem, that you
are!

\punch: May this pot of four half choke me, if she aint in the family way. I
knows a lady what's got a white swelling quick as I claps eyes on her.

\N2: The young surgeon, however, rose and begged the company to excuse his
...
sufferings of the lady who was \french{enceinte} which she had borne with
a laudable fortitude and she had given birth to a bouncing boy.

\dixon: I want patience, with those who, without wit to enliven or learning
to instruct, revile an ennobling profession which, saving the reverence
due to the Deity, is the greatest power for happiness upon the earth. I am
...
\punch: Stap my vitals, them was always the sentiments of honest Frank
...
\N1: To revert to Mr Bloom who, after his first entry, had been conscious
...
\french{mots} were such that his intellects resiled from: nor were they
scrupulously sensible of the proprieties though their fund of strong
animal spirits spoke in their behalf.

\N2: But the word of Mr Costello was an unwelcome language for him for he
...
\N3: To conclude, while from the sister's words he had reckoned upon a
speedy delivery he was, however, it must be owned, not a little alleviated
...
\N1: Accordingly he broke his mind to his neighbour, saying that, to
express his notion of the thing, his opinion (who ought not perchance to
express one) is:

\Bloom: That one must have a cold constitution and a frigid genius not
...
\N2: The dressy young blade said it was her husband's that put her in that
expectation or at least it ought to be unless she were another Ephesian
matron.

\N3: I must acquaint you, said Mr Crotthers, clapping on the table so as
to evoke a resonant comment of emphasis.

\crotthers: Old Glory Allelujurum was round again today, an elderly man with
...
for that the event would burst anon. 'Slife, I'll be round with you.
I cannot but extol the virile potency of the old bucko that could still
knock another child out of her.

\N1: All fell to praising of it, each after his own fashion, though the
...
\Bloom: \stage{to himself}
The wonderfully unequal faculty of metempsychosis possessed by them, that
the puerperal dormitory and the dissecting theatre should be the
seminaries of such frivolity, that the mere acquisition of academic titles
should suffice to transform in a pinch of time these votaries of levity
into exemplary practitioners of an art which most men anywise eminent have
esteemed the noblest. But, it is mayhap to relieve the pentup feelings
...
dissimulated, the acardiac \latin{foetus in foetu} and aprosopia due to a
...
distressing manner of delivery called
...
supernumerary digits, negro's inkle, strawberry mark
...
\N1: A heated argument having arisen between Mr Delegate Madden and Mr
...
\N2: Hitherto silent, whether the better to show by preternatural gravity
...
the recess appeared \dots Haines! Which of us did not feel his flesh creep!
He had a portfolio full of Celtic literature in one hand, in the other a
phial marked \emph{Poison}. Surprise, horror, loathing were depicted on all
...
stalks me. Dope is my only hope \dots Ah! Destruction! The black panther!
...
vendetta of Mananaun! The sage repeated: \latin{Lex talionis}.
...
pitches her web in the solitude. The nocturnal rat peers from his hole.
...
\N1: A score of years are blown away. He is young Leopold.
...
\N3: He thinks of a drizzling night in Hatch street, hard by the bonded
...
the willer with the willed, and in an instant (\latin{fiat!})
...
\N3: No, Leopold. Name and memory solace thee not.
...
trooping to the sunken sea, \latin{Lacus Mortis}. Ominous revengeful
zodiacal host! They moan, passing upon the clouds, horned and capricorned,
the trumpeted with the tusked, the lionmaned, the giantantlered, snouter
...
\stephen: You have spoken of the past and its phantoms. Why think of them? If I
call them into life across the waters of Lethe will not the poor ghosts
troop to my call? Who supposes it? I, Bous Stephanoumenos,
...
\lynch: That answer and those leaves, will adorn you more fitly when
something more, and greatly more, than a capful of light odes can call
your genius father. All who wish you well hope this for you. All desire to
see you bring forth the work you meditate, to acclaim you Stephaneforos. I
heartily wish you may not fail them.

\lenehan: O no, Vincent. Have no fear.
...
\N3: But in the straight on the run home when all were in close order the
dark horse Throwaway drew level, reached, outstripped her.

\N1: All was lost now.

\N2: Phyllis was silent: her eyes were sad anemones. Juno, she cried, I am
undone. But her lover consoled her and brought her a bright casket of gold
in which lay some oval sugarplums which she partook. A tear fell: one
only.

\lenehan: A whacking fine whip is W. Lane. Four winners yesterday and
...
bear it as was the ancient wont. Mercy on the luckless! Poor Sceptre!
\stage{sighing} She is not the filly that she was. Never, by this
hand, shall we behold such another. By gad, sir, a queen of them. Do you
remember her, Vincent?

\lynch: I wish you could have seen my queen today.
...
\lenehan: The gods too are ever kind.
...
\mulligan: \stage{whispering} Warily, preserve a druid silence.
...
\stephen: Theosophos told me so, whom in a previous existence
...
\N2: Must we accept the view of Empedocles of Trinacria
that the right ovary (the postmenstrual period, assert others)
...
\N3: The other problem raised by the same inquirer is scarcely less vital:
infant mortality. It is interesting because, as he pertinently remarks, we
are all born in the same way but we all die in different ways.

\mulligan: I blame the sanitary conditions in which our greylunged citizens
contract adenoids, pulmonary complaints etc. by inhaling the bacteria
which lurk in dust. These factors, and the revolting spectacles offered by
our streets, hideous publicity posters, religious ministers of all
...
unfructified duennas---these are accountable for any and every fallingoff
in the calibre of the race. Kalipedia will soon be generally adopted and
all the graces of life, genuinely good music, agreeable literature, light
philosophy, instructive pictures, plastercast reproductions of the
classical statues such as Venus and Apollo, artistic coloured photographs
of prize babies, all these little attentions would enable ladies who were
in a particular condition to pass the intervening months in a most
enjoyable manner.

\crotthers: I attribute some of these demises to abdominal trauma in the case
...
\N2: An ingenious suggestion is that thrown out by Mr V. Lynch:

\lynch: Both natality and mortality, as well as all other phenomena of evolution,
...
\stephen: An omnivorous being which can masticate, deglute,
...
\N3: Was the telling rejoinder of his interlocutor, none the less
...
happy \french{accouchement}. It had been a weary weary while both for
...
\N2: And as her loving eyes behold her babe she wishes only one blessing
...
\N1: And Doady, knock the ashes from your pipe, the seasoned briar you
...
\N3: Outflings my lord Stephen, giving the cry, and a tag and bobtail
...
\N1: Nurse Callan taken aback in the hallway cannot stay them nor smiling
...
\N2: They are out, tumultuously, off for a minute's race, all bravely
...
\Bloom: Madam, when comes the storkbird for thee?

\N1: The air without is impregnated with raindew moisture, life essence
celestial, glistening on Dublin stone there under starshiny \latin{coelum}.
God's air, the Allfather's air, scintillant circumambient cessile air.

\N2: Breathe it deep into thee. By heaven, Theodore Purefoy, thou hast
...
\N2: Twenty years of it, regret them not. With thee it was not as with
...
\N3: Forward to the ribbon counter.

\dixon: Where's Punch?

\N1: All serene.

\bystander: Jay, look at the drunken minister coming out of the maternity hospal!

\mulligan: \latin{Benedicat vos omnipotens Deus, Pater et Filius}.
...
\bannon: \french{En avant, mes enfants}!

\lenehan: Fire away number one on the gun.
...
\lynch: No, no, Mulligan! Abaft there! Shove ahead.

\lenehan: Keep a watch on the clock. Chuckingout time.

\madden: Mullee! What's on you?

\mulligan: \french{Ma mère m'a mariée}.
...
\stephen: To be printed and bound at the Druiddrum press by two designing females.
Calf covers of pissedon green. Last word in art shades.
Most beautiful book come out of Ireland my time.

\crotthers: \latin{Silentium}! Get a spurt on.

\lenehan: Tention. Proceed to nearest canteen and there annex liquor stores.

\punch: March! Tramp, tramp, tramp, the boys are (atitudes!) parching.

\madden: Beer, beef, business, bibles, bulldogs, battleships, buggery and bishops.

\dixon: Whether on the scaffold high.

\madden: Beer, beef, trample the bibles.

\dixon: When for Irelandear.

\crotthers: Trample the trampellers.
...
\dixon: Rugger. Scrum in. No touch kicking.

\lynch: Wow, my tootsies!

\dixon: You hurt? Most amazingly sorry!
...
\stephen: Mead of our fathers for the \german{Übermensch}.
...
\N2: Winding of his ticker.

Bl: Stopped short never to go again when the old.

\stephen: Absinthe for me, savvy?

\mulligan: \spanish{Caramba!} Have an eggnog or a prairie oyster.
...
\dixon: Got a prime pair of mincepies, no kid.
...
\stage{Exit Madden. Enter Bantam Lyons}
...
\mulligan: \french{Bonsoir la compagnie}.
...
\lynch: That, sir, was once a prosperous cit.
...
\french{Tiens, tiens}, but it is well sad, that, my faith, yes.
...
\stephen: \latin{Laetabuntur in cubilibus suis}.
...
\stephen: \latin{Ut implerentur scripturae}.
Strike up a ballad.
...
\dowie: Alexander J Christ Dowie, that's my name, that's
