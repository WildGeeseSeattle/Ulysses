...
\newcommand{\N}[1]{\role{N#1}}
\newcommand{\Nurses}{\role{Nurses}}
\newcommand{\All}{\role{All}}
\newcommand{\Ba}{\role{Bannon}}
\newcommand{\Bl}{\role{Bloom}}
\newcommand{\BL}{\role{Bantam Lyons}}
\newcommand{\Br}{\role{Barman}}
\newcommand{\By}{\role{Bystander}}
\newcommand{\Cr}{\role{Crotthers}}
\newcommand{\Dw}{\role{Dowie}}
\newcommand{\Dx}{\role{Dixon}}
\newcommand{\Ln}{\role{Lenehan}}
\newcommand{\Ly}{\role{Lynch}}
\newcommand{\Md}{\role{Madden}}
\newcommand{\Mu}{\role{Mulligan}}
\newcommand{\nc}{\role{Nurse Callan}}
\newcommand{\nq}{\role{Nurse Quigley}}
\newcommand{\PC}{\role{Punch}}
\newcommand{\SD}{\role{Stephen}}
...
\PC: \song{The first three months she was not well, staboo.}
...
\SD: \song{Behold the mansion reared by dedal Jack{}\\
...
\Ly: \song{Pope Peter's but a pissabed.\\
...
\Mu: \latin{Talis ac tanta depravatio hujus seculi, O quirites, ut
...
\Mu: \stage{to Bloom} Pray, sir, was you in need of any professional
...
\Bl: I am come here about a lady, now an inmate of Horne's house, that is
...
\Dx: Whether your incipient ventripotence betokens an ovoblastic gestation
...
\Ba: \french{Mais bien sûr}, noble stranger, \french{et mille compliments}.
...
\Ba: Ah, Monsieur, had you but beheld her as I did with these eyes at that
...
\Ba: Beneficent Disseminator of blessings to all Thy creatures, how great
...
\Mu: My friend Monsieur Moore, that most accomplished traveller (I have
...
\Ly: Pooh! A \french{livre}! The clumsy things are dear at a sou. One
...
\PC: A monstrous fine bit of cowflesh! I'll be sworn she has rendezvoused
you. What, you dog? Have you a way with them?

\Ly: Gad's bud, immensely so. The bedside manner it is that they use in
...
\PC: May this pot of four half choke me, if she aint in the family way. I
...
\Dx: I want patience, with those who, without wit to enliven or learning
...
\Cr: Old Glory Allelujurum was round again today, an elderly man with
...
\SD: You have spoken of the past and its phantoms. Why think of them? If I
...
\Ly: That answer and those leaves, will adorn you more fitly when
...
\Mu: \stage{whispering} Warily, preserve a druid silence.
...
\Mu: I blame the sanitary conditions in which our greylunged citizens
...
\Mu: \latin{Benedicat vos omnipotens Deus, Pater et Filius}.
...
\Ba: \french{En avant, mes enfants}!
...
\Cr: \latin{Silentium}! Get a spurt on.
...
\SD: Mead of our fathers for the \german{Übermensch}.
...
\Mu: \spanish{Caramba!} Have an eggnog or a prairie oyster.
...
\Mu: \french{Bonsoir la compagnie}.
...
\SD: \latin{Laetabuntur in cubilibus suis}.
...
\SD: \latin{Ut implerentur scripturae}.
Strike up a ballad.
