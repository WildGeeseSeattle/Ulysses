...
\N6:
So,
bevelling around by Mullett's and the Signal House which they shortly reached,
...
\N2:
Stephen,
that is when the accosting figure came to close quarters,
...
\N5:
Alluding to the encounter he said,
laughingly,
...
moored alongside Customhouse quay |
...
with an egg apiece for Maggy,
Boody and Katey,

\N6:
the cat meanwhile |
under the mangle devouring |
a mess of eggshells and charred fish heads and bones |
...
Dr~Mulligan,
as a guide,
philosopher and friend if I were in your shoes.
...
except he put it down to sheer cussedness or jealousy,
pure and simple.
...
\N4:
to judge by two or three low·spirited remarks he let drop
...
\N4:
fell to wool·gathering on the enormous dimensions of the water about the globe,
...
\N2:
Anyhow they passed the sentrybox with stones,
brazier etc.\
