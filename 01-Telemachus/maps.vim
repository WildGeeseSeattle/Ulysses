...
nnoremap <silent> ;sd 0i\Stephen:<CR><Esc>
nnoremap <silent> ;si 0i<CR>\StephenInt:<CR><Esc>
nnoremap <silent> ;mu 0i\Mulligan:<CR><Esc>
nnoremap <silent> ;ha 0i\Haines:<CR><Esc>
nnoremap <silent> ;ow 0i\OldWoman:<CR><Esc>
nnoremap <silent> ;ym 0i\YoungMan:<CR><Esc>
