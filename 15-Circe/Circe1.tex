...
\input{defs}
% \input{largeprint}
\renewcommand{\gab}[1]{\marginpar{\tiny #1}}
...
Stephen is rat·arsed with drink and absinthe.
Leopold Bloom,
...
\Stephen:
\latin{Vidi aquam egredientem de templo |
a latere dextro.
Alleluia.}
...
He gazes ahead,
reading on the wall
a scrawled chalk legend \Title{Wet Dream}
...
a copy of the \Title{Irish Times}
in her hand,
in tone of reproach,
pointing.
...
Hello.
\Title{Freeman's Urinal}
and \Title{Weekly Arsewipe}
here.
Paralyse Europe.
You which?
Bluebags?
...
of the \Title{Theatre Royal}
at a command performance of \french{La Cigale}.
\gab{1020}
...
A streamer bearing the legends \irish{Céad Mile Fáilte}
and
\hebrew{Mah Ttob Melek Israel}
spans the street.
\gab{1400}
