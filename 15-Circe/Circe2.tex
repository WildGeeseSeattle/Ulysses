%--------------------------------------------------
\commentary{1. \textsc{Circe} --- Cardinal Fantasy}
%--------------------------------------------------
...
in talk with the whores on the doorstep,
pricks his ears.
...
Bad luck.
Hook in wrong tache of her \ldots
person you mentioned.
That night she met \ldots
Now!
...
%--------------------------------------------------
\commentary{2. \textsc{Unmanned} --- Bello Fantasy}
%--------------------------------------------------
...
\N2:
\emph{Bello},
\emph{his} heavy cheekchops sagging.
...
flour-smeared,
a rollingpin stuck with raw pastry |
...
Ho! Ho!
I have to laugh!
That secondhand black opera-top shift |
...
\Bello:
\stage{(cuttingly)}
Their heelmarks will stamp the Brusselette carpet |
you bought at Wren's auction.
In their horseplay with Moll |
...
%--------------------------------------------------
\commentary{3. \textsc{Nymph} --- Nymph Fantasy}
%--------------------------------------------------
...
lightly clad in teabrown art colours,
...
pamphlet of which I received some days ago,
...
and among the leaves and break,
...
\N1:
Through silver-silent summer air the dummy of Bloom,
rolled in a mummy,
...
\gab{3420}%
a bird chief,
blue-streaked and feathered in war panoply with his assegai,
...
\N2:
The Yews,
their silverfoil of leaves precipitating,
...
\Bloom:
A holy abbot you want or Brophy,
the lame gardener,
...
You fee mendancers on the Riviera,
I read.
...
%--------------------------------------------------
\commentary{4. \textsc{Luck and Money}}
%--------------------------------------------------
...
\gab{3510}
Forfeits,
a fine thing and a superfine thing.
...
taking out a banknote by its corner,
hands it to her,
...
smiling |
and chants to the air of the bloodoath |
...
rectorial,
reproving,
the head of Don John Conmee rises from the pianola coffin.
...
%--------------------------------------------------
\commentary{5. \textsc{Voyeur} --- Cuckold Fantasy,
Shakespeare}
%--------------------------------------------------
...
\gab{3730}
Sadly over the crossblind,
Lydia Douce and Mina Kennedy gaze.
The Boots,
jogging,
mocks them with thumb and wriggling wormfingers.
...
Lenehan,
in yachtsman's cap and white shoes,
\gab{3740}
...
\N1:
Bloom,
in flunkey's prune plush coat and kneebreeches,
\gab{3760}
...
after his death \ldots

\N2:
Mrs~Dignam,
widow woman,
her snubnose and cheeks flushed with deathtalk,
...
%--------------------------------------------------
\commentary{6. \textsc{Dance of Death}}
%--------------------------------------------------
...
very eccentric |
where lots cocottes beautiful dressed much about princesses like |
are dancing cancan and walking there |
parisian clowneries |
extra foolish for bachelors foreigns |
the same if talking a poor english |
how much smart they are |
on things love and sensations voluptuous.
...
very fresh young with \french{dessous troublants}.
...
and holy apostles big damn ruffians.
\french{Demimondaines} nicely handsome sparkling of diamonds |
very amiable costumed.
Or do you are fond better |
what belongs they |
...
\Stephen:
Caoutchouc statue woman |
reversible or lifesize tompeeptom of virgins nudities |
very lesbic |
the kiss five ten times.
Enter,
gentleman,
to see in mirror |
...
in warm veal liver or omlet |
on the belly \french{pièce de Shakespeare}.
...
under the leaves.
The pack of staghounds follows,
nose to the ground,
...
Flathouse,
Nine Mile Stone,
follow the footpeople with knotty sticks,
hayforks,
salmongaffs,
lassos,
flockmasters with stockwhips,
bearbaiters with tomtoms,
toreadors with bullswords,
greynegroes waving torches.
\gab{3960}
...
Garrett Deasy,
bolt upright,
his nailscraped face plastered with postagestamps,
brandishes his hockeystick,
...
\N1:
Private Carr,
Private Compton and Cissy Caffrey pass beneath the windows,
singing in discord.
...
\gab{4020}
He sits tinily on the pianostool |
and lifts and beats |
...
on the toepoint of which |
spins a silk hat.
With a deft kick,
he sends it spinning to his crown |
and jauntyhatted skates in.
...
He twirls in reversed directions a clouded cane,
...
\Pianola[2]:
\begin{verse}
    Two young fellows were talking about their girls,
girls,
girls,\\
...
The twilight hours advance from long landshadows,
dispersed,
lagging,
languid-eyed,
...
\Kitty:
O,
they played that on the hobbyhorses at the \Title{Mirus} bazaar!
...
Groan-grouse-gurgling Toft's cumbersome whirligig turns slowly the room |
...
\N1:
Stephen with hat ashplant frog |
splits in middle high kicks |
...
with hobbyhorse riders from gilded snakes dangled,
...
ropepulling hitching stamp |
hornpipe through and through.
Baraabum!

\N2:
On nags hogs bellhorses~/
Gadarene swine~/
...
two trickies~/
Frauenzimmer~/
plumstained from pram~/
falling bawling.
Gum he's a champion.
Fuseblue peer from barrel~/
rev. evensong Love on hackney jaunt~/
Blazes blind~/
coddoubled bicyclers |
Dilly with snowcake~/
no fancy clothes.
...
her face worn and noseless,
green with gravemould.
...
\begin{verse}
\latin{%
    Liliata rutilantium te confessorum \ldots\\
    Iubilantium te virginum \ldots}
\end{verse}
...
breathing upon him softly her breath of wetted ashes.
...
Lord,
for my sake!
Inexpressible was my anguish when expiring with love,
grief and agony
\gab{4240}%
on Mount Calvary.
...
\N1:
Stephen lifts his ashplant high with both hands |
...
\N1:
Stephen,
abandoning his ashplant,
his head and arms thrown back stark,
beats the ground and flies from the room,
...
On the doorstep,
all the whores clustered talk volubly,
...
\N2:
After him |
fresh found the hue and cry |
zigzag gallops in hot pursuit |
of follow my leader:
65~C,
66~C,
Night Watch,
...
\DonEmile:
Werf those eykes to footboden,
big grand porcos of john-yellows todos |
covered of gravy!
...
sends gouts of sperm spouting through his deathclothes |
on to the cobblestones.
Mrs~Bellingham,
Mrs~Yelverton Barry,
\gab{4550}%
...
where I am least likely to meet these necessary evils?
\french{Ça se voit aussi à Paris.}
Not that I \ldots
But,
by Saint Patrick \ldots!
...
On the altar-stone Mrs~Mina Purefoy,
goddess of unreason,
lies,
naked,
fettered,
...
acushla.
At 8.35~\textsc{a.m.},
you will be in heaven and Ireland will be free.
...
Virag,
you don't know him (poor fellow,
he's laid up for the past week)
and we had a liquor together |
and I was just making my way home \ldots
...
\Corny:
\gab{4880}
Sure it was Behan our jarvey there |
that told me after we left the two commercials in Mrs~Cohen's |
...
awkwardly,
and turn.
Corny Kelleher on the sideseat |
...
\stage{(he murmurs)}
\ldots swear that I will always hail,
ever conceal,
never reveal,
any part or parts,
art or arts \ldots
